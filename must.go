...
func (p *Page) MustSetWindow(left, top, width, height int) *Page {
	p.e(p.SetWindow(&proto.BrowserBounds{
		Left:        lazyjson.Int(left),
		Top:         lazyjson.Int(top),
		Width:       lazyjson.Int(width),
		Height:      lazyjson.Int(height),
...
func (p *Page) MustExpose(name string, fn func(lazyjson.JSON) (interface{}, error)) (stop func()) {
...
func (p *Page) MustEval(js string, params ...interface{}) lazyjson.JSON {
...
func (p *Page) MustObjectToJSON(obj *proto.RuntimeRemoteObject) lazyjson.JSON {
...
func (p *Page) MustObjectsToJSON(list []*proto.RuntimeRemoteObject) lazyjson.JSON {
	arr := []interface{}{}
...
func (el *Element) MustProperty(name string) lazyjson.JSON {
...
func (el *Element) MustEval(js string, params ...interface{}) lazyjson.JSON {
